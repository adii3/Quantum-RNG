...
{
    [SourceLocation("C:\\Users\\smehr\\Documents\\QuantumRNG\\Program.qs", OperationFunctor.Body, 8, 15)]
...
#line hidden
            {
#line 9 "C:\\Users\\smehr\\Documents\\QuantumRNG\\Program.qs"
                var q = Allocate.Apply();
#line hidden
                bool __arg1__ = true;
                try
                {
#line 10 "C:\\Users\\smehr\\Documents\\QuantumRNG\\Program.qs"
                    MicrosoftQuantumIntrinsicH.Apply(q);
#line 11 "C:\\Users\\smehr\\Documents\\QuantumRNG\\Program.qs"
...
#line hidden
    ...
    [SourceLocation("C:\\Users\\smehr\\Documents\\QuantumRNG\\Program.qs", OperationFunctor.Body, 15, 28)]
    public partial class SampleRandomNumberInRange : Operation<Int64, Int64>, ICallable
    {
        ...
        {
            var max = __in__;
#line 16 "C:\\Users\\smehr\\Documents\\QuantumRNG\\Program.qs"
            var output = 0L;
#line 17 "C:\\Users\\smehr\\Documents\\QuantumRNG\\Program.qs"
            while (true)
            {
#line 18 "C:\\Users\\smehr\\Documents\\QuantumRNG\\Program.qs"
                var bits = QArray<Result>.Create(0L);
#line 19 "C:\\Users\\smehr\\Documents\\QuantumRNG\\Program.qs"
                foreach (var idxBit in new QRange(1L, MicrosoftQuantumMathBitSizeI.Apply(max)))
#line hidden
                {
#line 20 "C:\\Users\\smehr\\Documents\\QuantumRNG\\Program.qs"
                    bits = QArray<Result>.Add(bits, new QArray<Result>(GenerateRandomBit.Apply(QVoid.Instance)));
                }

#line 22 "C:\\Users\\smehr\\Documents\\QuantumRNG\\Program.qs"
...
#line 24 "C:\\Users\\smehr\\Documents\\QuantumRNG\\Program.qs"
            return output;
        }
    ...
    [SourceLocation("C:\\Users\\smehr\\Documents\\QuantumRNG\\Program.qs", OperationFunctor.Body, 28, -1)]
    public partial class SampleRandomNumber : Operation<QVoid, Int64>, ICallable
    {
        ...
        {
#line 29 "C:\\Users\\smehr\\Documents\\QuantumRNG\\Program.qs"
            var max = 50L;
#line 30 "C:\\Users\\smehr\\Documents\\QuantumRNG\\Program.qs"
            Message.Apply(String.Format("Sampling a random number between 0 and {0}: ", max));
#line 31 "C:\\Users\\smehr\\Documents\\QuantumRNG\\Program.qs"
